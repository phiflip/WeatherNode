...
uint8_t devEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0xD0, 0x00 };
uint8_t appKey[] = { 0x0A, 0xC3, 0x21, 0x1D, 0xDD, 0x27, 0x10, 0xE0, 0xA7, 0x98, 0xDD, 0x05, 0x6D, 0x6C, 0xF3, 0x00 };
...
static bool prepareTxFrame(uint8_t port, uint8_t restart) {
  ...
  unsigned int Duty_payload = appTxDutyCycle / 1000;
